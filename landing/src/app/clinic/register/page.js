...
const COUNTRY_CODES = [
  ...
  { code: "+853", label: "Macau SAR China (+853)" },
  ...
  { code: "+1-869", label: "St. Kitts & Nevis (+1-869)" },
  { code: "+1-758", label: "St. Lucia (+1-758)" },
  { code: "+590", label: "St. Martin (+590)" },
  { code: "+508", label: "St. Pierre & Miquelon (+508)" },
  { code: "+1-784", label: "St. Vincent & Grenadines (+1-784)" },
...
export default function ClinicRegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Extract hostname from website URL if possible
      let domainString = formData.website || "";
      ...
      const payload = {
        ...
        ownerName: formData.doctorName,
        ownerEmail: formData.email,
        password: formData.password,
        allowedDomains: domainString,
        // Send other fields if the backend ever needs them
    ...
    <div className={styles.pageContainer}>
      <div className={styles.card}>
        ...
        <div className={styles.cardHeader}>
          ...
          <p>Join SORA Fertility to automate leads and assessments.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              name="clinicName"
              className={styles.input}
              placeholder="e.g. SORA Fertility Center"
        ...
        <div className={styles.loginLink}>
          Already have an account? <Link href="/clinic/login">Log in here</Link>
        </div>
      </div>
    </div>
  );
