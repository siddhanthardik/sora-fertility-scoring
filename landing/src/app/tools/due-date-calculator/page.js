...
const insightsData = {
  ...
  4: { emoji: "🍒", size: "a poppy seed", clinicalSize: "Length: ~0.1 cm • Weight: <1 g", tagline: "Tiny but mighty!", what: ["Implantation is completing.", "The amniotic sac is forming.", "The neural tube (which develops into the brain and spinal cord) is beginning to develop."], didYouKnow: "Many women don't yet realize they're pregnant during this week.", tip: "Begin taking folic acid if you haven't already." },
  ...
  16: { emoji: "🥑", size: "an avocado", clinicalSize: "Length: ~11.6 cm • Weight: ~100 g", tagline: "Hearing is developing.", what: ["The heart is pumping 25 quarts of blood a day.", "Scalp patterning has begun.", "You might start feeling 'flutters' (quickening)."], didYouKnow: "Your baby can hear your heartbeat and the rumble of your stomach.", tip: "Consider starting to sleep on your side to improve blood flow." },
